 ...
 */
static __inline void __list_add(list_t *newer,
                                list_t *prev,
                                list_t *next)
{
    next->prev = newer;
 ...
 */
static __inline void list_add(list_t *newer, list_t *head)
{
 ...
 */
static __inline void list_add_tail(list_t *newer, list_t *head)
{
 ...
 */
static __inline void list_replace(list_t *old, list_t *newer)
{
    newer->next = old->next;
