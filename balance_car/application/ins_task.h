...
#ifndef BALANCE_CAR_INS_TASK_H
#define BALANCE_CAR_INS_TASK_H
#ifdef __cplusplus
extern "C" {
#endif

void ins_task(const void *pVoid);
...
void INS_EXTI_Callback(uint16_t GPIO_Pin);

#ifdef __cplusplus
}
#endif

#endif //BALANCE_CAR_INS_TASK_H
