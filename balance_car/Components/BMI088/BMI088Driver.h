...
#ifndef FIREFLYRTS_FIRMWARE_BMI088DRIVER_H
#define FIREFLYRTS_FIRMWARE_BMI088DRIVER_H
...
extern uint8_t bmi088_init_flag;
...
extern uint8_t bmi088_config_init(void);
...
extern void BMI088_gyro_read_over(uint8_t *rx_buf, float gyro[3], float gy_offset[3]);
extern void BMI088_temperature_read_over(uint8_t *rx_buf, float *temperate);
extern void BMI088_read(float gyro[3], float accel[3], float *temperate, float *gy_offset);
...
#endif //FIREFLYRTS_FIRMWARE_BMI088DRIVER_H
